...
def main():
    ...
    argument_spec = dict(
        ...
        vkey_file=dict(type='str', default='payment.vkey', required=True),
        skey_file=dict(type='str', default='payment.skey', required=True),
        addr_file=dict(type='str', default='payment.addr', required=True),
        state=dict(type='str', default='present', choices=['present']),
        active_network=dict(type='str', default='test', required=True,
                            choices=['test', 'main']),
